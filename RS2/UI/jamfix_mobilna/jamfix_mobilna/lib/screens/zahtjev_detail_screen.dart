...
class ZahtjevDetailScreen extends StatefulWidget {
  Zahtjev? zahtjev;
  ZahtjevDetailScreen({this.zahtjev, Key? key}) : super(key: key);
  @override
  State<ZahtjevDetailScreen> createState() => _ZahtjevDetailScreen();
}

class _ZahtjevDetailScreen extends State<ZahtjevDetailScreen> {
