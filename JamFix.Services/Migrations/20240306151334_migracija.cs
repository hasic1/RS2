    ...
    public partial class migracija : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Domanovici b.b", new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5417), "Bakir Hasic", 1, "Mostar", "Neki naziv", "Bakir Hasic", "Modem u kvaru", "Zamjena modema", "061-330-326" },
                    { 2, "Domanovici b.b", new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5433), "Arman Hasic", 1, "Mostar", "Ruter", "Amar Hasic", "Ruter u kvaru", "Zamijena rutera", "061-336-026" },
                    { 3, "Mostar", new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5439), "Dzemal Causevic", 2, "Mostar", "Kablovi", "Ramiz Dizdar", "Problemi sa konekcijom", "Zamijena kablova", "061-202-330" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1234-1234-1234-1234", "123", new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5719), "Bakir Hasic", "Trio paket", true, 1 },
                    { 2, "1235-1235-1235-1235", "123", new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5733), "Anel Hodzic", "Trio paket", true, 1 },
                    { 3, "1236-1236-1236-1236", "123", new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5739), "Hamza Dzeko", "Trio paket", true, 1 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Korisnik",
                columns: new[] { "KorisnikId", "Aktivnost", "DatumRodjenja", "DatumZaposlenja", "DrzavaId", "Email", "Ime", "KorisnickoIme", "LozinkaHash", "LozinkaSalt", "PozicijaId", "Prezime", "Status", "Telefon" },
                values: new object[,]
                {
                    { 1, true, new DateTime(2024, 12, 24, 16, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "admin@gmail.com", "Admin", "admin", "PEPuXC0FRTDz8Ep3LtkrCzwN0Kw=", "1wQEjdSFeZttx6dlvEDjOg==", 1, "Admin", true, "061-336-026" },
                    { 2, true, new DateTime(2024, 12, 24, 16, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "korisnik@gmail.com", "Korisnik", "korisnik", "PEPuXC0FRTDz8Ep3LtkrCzwN0Kw=", "1wQEjdSFeZttx6dlvEDjOg==", 2, "Korisnik", true, "061-336-026" },
                    { 3, true, new DateTime(2024, 12, 24, 16, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "zaposlenik@gmail.com", "Zaposlenik", "zaposlenik", "PEPuXC0FRTDz8Ep3LtkrCzwN0Kw=", "1wQEjdSFeZttx6dlvEDjOg==", 5, "Zaposlenik", true, "061-336-026" },
                    { 4, true, new DateTime(2024, 12, 24, 16, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "operater@gmail.com", "Operater", "operater", "PEPuXC0FRTDz8Ep3LtkrCzwN0Kw=", "1wQEjdSFeZttx6dlvEDjOg==", 6, "Operater", true, "061-336-026" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "500", "1000", "55", 65.0, "Trio start paket", "Za mala kucanstva", null, null, true, null, 1 },
                    { 2, "750", "1500", "75", 75.0, "Trio paket", "Za kucanstva", null, null, true, null, 1 },
                    { 3, "1000", "2000", "100", 90.0, "Trio super paket", "Najbolje u ponudi", null, null, true, null, 1 },
                    { 4, "500", "0", "25", 40.0, "Duo start paket", "Najbolje za mala kucanstva", null, null, true, null, 1 },
                    { 5, "600", "0", "50", 50.0, "Duo paket", "Novo u ponudi", null, null, true, null, 1 },
                    { 6, "1000", "0", "75", 65.0, "Duo super paket", "Najbolje u ponudi", null, null, true, null, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Domanovici", "061-336-026", new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5826), true, "Bakir Hasic", "Moj ruter je u kvaru", 1 },
                    { 2, "Mostar", "062-223-322", new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5838), false, "Arman Hodzic", "Moj modem je u kvaru", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(4052), 1, 1 },
                    { 2, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(4117), 2, 2 },
                    { 3, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(4123), 3, 3 },
                    { 4, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(4128), 4, 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5192), 3, 1 },
                    { 2, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5208), 5, 1 },
                    { 3, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5213), 3, 2 },
                    { 4, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5218), 4, 2 },
                    { 5, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5222), 5, 3 },
                    { 6, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5227), 4, 3 },
                    { 7, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5232), 4, 4 },
                    { 8, new DateTime(2024, 3, 6, 16, 13, 34, 381, DateTimeKind.Local).AddTicks(5237), 4, 5 }
                });
